...
const slides = [
  ...
  },
  {
    ...
    say: "Every payment also writes one line on Hedera. Anyone can see how much was paid.",
    call: "Hedera topic 0.0.10320508",
    points: ["one message per settle", "includes amount in tinybars"],
    run: "hcs",
